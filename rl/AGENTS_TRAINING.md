...
|---|---|---|
| `combat` | which card to play / end turn | HP retained this combat = `end_hp / start_hp` (**≥1.0 = perfect win**) |
| `card` | which card reward to take (or skip) | overall **game victory** (+ small act/floor progress shaping) |
